...
public class SheetsInitializer {
    ...
    public SheetsInitializer(MainActivity activity) {
        mActivity = activity;
    ...
    public void getResultsFromApi() {
        if (! isGooglePlayServicesAvailable()) {
            ...
            // Show message that Internet connection is not available.
        } else {
            new SheetsCallWrapper(mCredential, this).execute();
        }
    }
        ...
        switch(requestCode) {
            case REQUEST_GOOGLE_PLAY_SERVICES:
                if (resultCode != Activity.RESULT_OK) {
                    // Show Message that Google Play Services is not installed
                    /*mOutputText.setText(
